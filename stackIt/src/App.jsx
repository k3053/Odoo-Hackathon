        ...
        <main className="flex-1 p-4">
          ...
          <div className="my-4 flex items-center space-x-4 overflow-x-auto pb-2">
            <div className="flex-1 relative">
              ...
              <input type="text" placeholder="Search questions..." className="w-full pl-10 pr-4 py-2 bg-white/30 border border-white/40 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" />
            </div>
